...
from .configuration import (
    DEPLOYMENT, AMPLIFY_GITHUB_REPOSITORY_NAME, GITHUB_REPOSITORY_OWNER_NAME, GITHUB_TOKEN, get_all_configurations
)
...
class AmplifyStack(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, target_environment: str, **kwargs) -> None:
        ...
        amplify_app = amplify.App(self, f'{target_environment}-lmd-UI-app',
